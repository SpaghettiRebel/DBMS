...
void BP_tree<tkey, tvalue, t, compare>::ensure_page_exists(uint32_t page_id) {
    if (!_pager) {
...
template <typename tkey, typename tvalue, std::size_t t, typename compare>
void BP_tree<tkey, tvalue, t, compare>::serialize_node(
...
template <typename tkey, typename tvalue, std::size_t t, typename compare>
typename BP_tree<tkey, tvalue, t, compare>::bptree_node_base*
BP_tree<tkey, tvalue, t, compare>::deserialize_node(const char*& cur, const char* end) {
...
template <typename tkey, typename tvalue, std::size_t t, typename compare>
void BP_tree<tkey, tvalue, t, compare>::collect_leaves(
...
template <typename tkey, typename tvalue, std::size_t t, typename compare>
void BP_tree<tkey, tvalue, t, compare>::persist_to_disk() {
    if (!_pager || !_dirty) {
        return;
    }
...
template <typename tkey, typename tvalue, std::size_t t, typename compare>
void BP_tree<tkey, tvalue, t, compare>::load_from_disk() {
...
template <typename tkey, typename tvalue, std::size_t t, typename compare>
void BP_tree<tkey, tvalue, t, compare>::flush() {
    persist_to_disk();
    if (_pager) {
        _pager->file.flush();
    }
